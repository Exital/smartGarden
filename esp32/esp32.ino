...
RTC_DATA_ATTR bool need_irrigation = false;      /* Global boolian parameter of irrigation*/
...
void handle_water_height(){
  ...
  //publish_msg("Irigation", "Irrigation needed");
  }
  //TODO: check if to publish message if no needed irrigation
